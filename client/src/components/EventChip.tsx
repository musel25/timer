...
export function EventChip({ event }: { event: CalendarEvent }) {
  ...
  return (
    <div className="calendar-event flex items-start gap-1.5 rounded-lg border border-ink-600/60 bg-ink-900/40 px-2 py-1.5 text-xs text-slate-400" title={event.title}>
